...
const ALL_ITEMS = [
  ...
  { id: 15, title: '谢谢参与', icon: <Cloud className="w-5 h-5 text-gray-400" />, value: '¥0', type: 'filler' },
  { id: 16, title: '谢谢参与', icon: <Music className="w-5 h-5 text-gray-400" />, value: '¥0', type: 'filler' },
  { id: 17, title: '谢谢参与', icon: <Camera className="w-5 h-5 text-gray-400" />, value: '¥0', type: 'filler' },
  { id: 18, title: '谢谢参与', icon: <Moon className="w-5 h-5 text-gray-400" />, value: '¥0', type: 'filler' },
